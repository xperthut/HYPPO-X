...
string Phenotype::toString(){
    return "[ID:<" + to_string(varietyID) + "," + date + "," + site + ">, Type:<" + GetType() + "> UID:" + to_string(this->ci.GetUniqueID()) + " ClusterIDs:<" + GetClusterIdList() + ">, Value:" + to_string(value) + " FaceWeight:" + to_string(GetWeight()) + "]\n";
    
}

string Phenotype::toString(short index1, short index2){
    return "[ID:<" + to_string(varietyID) + "," + date + "," + site + ">, Type:<" + GetType(index1, index2) + "> UID:" + to_string(this->ci.GetUniqueID()) + " ClusterIDs:<" + GetClusterIdList() + ">, Value:" + to_string(value) + " FaceWeight:" + to_string(GetWeight(index1, index2)) + "]\n";
}
