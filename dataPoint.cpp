...
DataPoint::DataPoint(float *pos){
    this->boxID = 0;
    this->varietyList = NULL;
    this->maxIndex = 0;
    
    this->position = (float*)malloc(sizeof(float)*Config::FILTER);
...
string DataPoint::toString(){
    ...
    return "["+ s + ">, Type:<" + GetType() + "> UID:" + to_string(this->GetUniqueID()) + " ClusterIDs:<" + GetClusterIdList() + ">, FaceWeight:" + to_string(GetWeight()) + "]\n";
...
string DataPoint::toString(short index1, short index2){
    ...
    return "["+ s + ">, Type:<" + GetType(index1, index2) + "> UID:" + to_string(this->GetUniqueID()) + " ClusterIDs:<" + GetClusterIdList() + ">, FaceWeight:" + to_string(GetWeight(index1, index2)) + "]\n";
}
