...
void QuadTree::SearchSurface(float x1, float y1, float x2, float y2, list<Phenotype*> *phList, list<DataPoint*> *dpList, unsigned long boxID){
    
    this->SearchSurfaceInNode(this->root, x1, y1, x2, y2, phList, dpList, boxID);
}

void QuadTree::SearchDataPoints(float x1, float y1, float x2, float y2, unordered_set<unsigned long> *boxIdList){
...
int QuadTree::SearchSurfaceInNode(QuadNode *node, float x1, float y1, float x2, float y2, list<Phenotype *> *phList, list<DataPoint*> *dpList, unsigned long boxID){
    if(node == NULL) return 0;
...
int QuadTree::SearchDataPoint(QuadNode *node, float x1, float y1, float x2, float y2, unordered_set<unsigned long> *boxIdList){
    if(node == NULL) return 0;
