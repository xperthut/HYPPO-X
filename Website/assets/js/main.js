    ...
    var _ = {
        ...
        initProperties: function () {
            ...
            _.$viewer = $(
                    ...
                    '<div id="svg-container"><svg width="' + _.$window.width() + '" height="' + _.$window.height() + '"></svg></div>' +
                    '</div>' +
                    '<canvas width="' + _.$window.width() + '" height="' + _.$window.height() + '" style="display:none"></canvas>' +
                    '</div>'
                    ).appendTo(_.$body);
