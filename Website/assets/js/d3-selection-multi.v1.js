...
(function (global, factory) {
    ...
    function attrsObject(selection$$1, map) {
        for (var name in map)
            selection$$1.attr(name, map[name]);
        return selection$$1;
    }
    ...
    function stylesObject(selection$$1, map, priority) {
        for (var name in map)
            selection$$1.style(name, map[name], priority);
        return selection$$1;
    }
    ...
    function propertiesObject(selection$$1, map) {
        for (var name in map)
            selection$$1.property(name, map[name]);
        return selection$$1;
    }
    ...
    function attrsObject$1(transition$$1, map) {
        for (var name in map)
            transition$$1.attr(name, map[name]);
        return transition$$1;
    }
    ...
    function stylesObject$1(transition$$1, map, priority) {
        for (var name in map)
            transition$$1.style(name, map[name], priority);
        return transition$$1;
    }
