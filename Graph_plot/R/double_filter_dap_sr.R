...
# --------------------------------------------------------------------------------------------------
# File name: double_filter_dap_sr.R
# Objective: View topological object for double filter function {DAP,Solar radiation}
# Additional information: NA
# --------------------------------------------------------------------------------------------------
# Contributors                   Date            Task details
# -------------------------    ----------      --------------------
# Md. Kamruzzaman              03/15/2017      Initial version
# 
# **************************************************************************************************/
